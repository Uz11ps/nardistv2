...
export class BotService {
  ...
  getBotMove(state: GameState): BotMove | null {
    ...
    // Улучшенная эвристика для среднего уровня сложности
    // Приоритеты:
    // 1. Безопасность фишек (избегаем одиночных фишек)
    // 2. Бить фишки противника (агрессивные ходы)
    // 3. Занимать важные позиции (точки, блоки)
    // 4. Выводить фишки с бара
    // 5. Двигаться к дому
    // 6. Блокировать противника
